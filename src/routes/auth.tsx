    ...
    <main className="flex min-h-screen items-center justify-center bg-parchment-white px-4 py-10">
      <div className="w-full max-w-sm border border-ink-black/20 bg-parchment-white p-6 shadow-md">
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 border border-ink-black bg-parchment-white px-4 py-2 font-metadata text-[11px] uppercase tracking-[0.2em] text-ink-black transition-opacity disabled:opacity-60"
        >
