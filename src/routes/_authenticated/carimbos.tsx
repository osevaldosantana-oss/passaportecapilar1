...
const pageCss = "\n        .material-symbols-outlined {\n            font-variation-settings: 'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24;\n        }\n        .stamp-shadow {\n            filter: drop-shadow(0px 4px 12px rgba(139, 0, 0, 0.15));\n        }\n        .bg-texture {\n            background-color: #F9F6F0;\n            background-image: url(\"data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100' height='100' filter='url(%23noise)' opacity='0.05'/%3E%3C/svg%3E\");\n        }\n\n        /* Stamp Entrance Animations */\n        @keyframes stampIn {\n            0% { transform: scale(1.2); opacity: 0; }\n            50% { transform: scale(0.95); opacity: 1; }\n            70% { transform: scale(1.02); }\n            100% { transform: scale(1); opacity: 1; }\n        }\n        .animate-stamp-1 { animation: stampIn 0.5s cubic-bezier(0.25, 1, 0.5, 1) 0.1s both; }\n        .animate-stamp-2 { animation: stampIn 0.5s cubic-bezier(0.25, 1, 0.5, 1) 0.3s both; }\n        .animate-stamp-3 { animation: stampIn 0.5s cubic-bezier(0.25, 1, 0.5, 1) 0.5s both; }\n        .animate-stamp-4 { animation: stampIn 0.5s cubic-bezier(0.25, 1, 0.5, 1) 0.7s both; }\n\n        /* Breathing Ambient Animations */\n        @keyframes breathe {\n            0%, 100% { filter: drop-shadow(0px 4px 12px rgba(139, 0, 0, 0.15)); }\n            50% { filter: drop-shadow(0px 4px 20px rgba(139, 0, 0, 0.35)); }\n        }\n        @keyframes breathe-burgundy {\n            0%, 100% { filter: drop-shadow(0px 4px 12px rgba(74, 14, 14, 0.15)); }\n            50% { filter: drop-shadow(0px 4px 20px rgba(74, 14, 14, 0.35)); }\n        }\n        @keyframes breathe-gold {\n            0%, 100% { filter: drop-shadow(0px 4px 12px rgba(197, 160, 89, 0.15)); }\n            50% { filter: drop-shadow(0px 4px 20px rgba(197, 160, 89, 0.35)); }\n        }\n        .stamp-breathe-1 { animation: breathe 3s ease-in-out infinite; }\n        .stamp-breathe-2 { animation: breathe-burgundy 3.5s ease-in-out infinite; }\n        .stamp-breathe-3 { animation: breathe-gold 4s ease-in-out infinite; }\n\n        /* Shimmer Effect */\n        .shimmer-effect {\n            position: relative;\n            overflow: hidden;\n        }\n        .shimmer-effect::after {\n            content: '';\n            position: absolute;\n            top: -50%;\n            left: -50%;\n            width: 200%;\n            height: 200%;\n            background: linear-gradient(to right, rgba(255,255,255,0) 0%, rgba(255,255,255,0.4) 50%, rgba(255,255,255,0) 100%);\n            transform: rotate(30deg) translateX(-150%);\n            animation: shimmer 4s cubic-bezier(0.4, 0, 0.2, 1) infinite;\n            pointer-events: none;\n        }\n        @keyframes shimmer {\n            0% { transform: rotate(30deg) translateX(-150%); }\n            50% { transform: rotate(30deg) translateX(150%); }\n            100% { transform: rotate(30deg) translateX(150%); }\n        }\n\n        /* Interactive Hover State Overrides */\n        .stamp-interactive:hover .stamp-glow {\n            transform: scale(1.05);\n            filter: drop-shadow(0px 8px 24px rgba(0, 0, 0, 0.2));\n            z-index: 20;\n        }\n        .stamp-glow {\n            transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), filter 0.3s ease;\n        }\n    ";

export const Route = createFileRoute("/_authenticated/carimbos")({
  head: () => ({
    meta: [
      { title: "Meus Carimbos — Passaporte Capilar™" },
      { name: "description", content: "Coleção de carimbos conquistados a cada serviço concluído na sua jornada capilar." },
      { property: "og:title", content: "Meus Carimbos — Passaporte Capilar™" },
      { property: "og:description", content: "Coleção de carimbos conquistados a cada serviço concluído na sua jornada capilar." },
      ...
      <main className="max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop py-8 md:py-12">
        ...
        <div className="relative w-full rounded-xl overflow-hidden shadow-sm border border-outline-variant bg-[#F0EDE4] p-4 md:p-8 mb-chapter-gap">
          ...
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
            <div className="flex flex-col items-center group relative cursor-pointer stamp-interactive animate-stamp-1">
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full border-2 border-stamp-red/30 flex items-center justify-center relative mb-4 bg-parchment-white/80 backdrop-blur-sm stamp-breathe-1 stamp-glow shimmer-effect">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border border-stamp-red flex items-center justify-center border-dashed">
                  <div className="text-stamp-red text-center relative z-10">
            ...
            <div className="flex flex-col items-center group relative cursor-pointer pt-8 md:pt-16 stamp-interactive animate-stamp-2">
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full border-2 border-deep-burgundy/30 flex items-center justify-center relative mb-4 bg-parchment-white/80 backdrop-blur-sm stamp-breathe-2 stamp-glow shimmer-effect">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border border-deep-burgundy flex items-center justify-center border-solid">
                  <div className="text-deep-burgundy text-center relative z-10">
                    <span className="material-symbols-outlined text-3xl mb-1" style={{ fontVariationSettings: "'FILL' 1" }}>
                      content_cut
                    </span>
                    <div className="font-headline-lg-mobile text-sm font-bold leading-tight">
            ...
            <div className="flex flex-col items-center group relative cursor-pointer pt-4 md:pt-8 stamp-interactive animate-stamp-3">
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full border-2 border-antique-gold/40 flex items-center justify-center relative mb-4 bg-parchment-white/80 backdrop-blur-sm stamp-breathe-3 stamp-glow shimmer-effect">
            ...
            <div className="flex flex-col items-center group relative cursor-pointer pt-12 md:pt-24 opacity-60 animate-stamp-4">
        ...
        <div className="mt-8 border border-outline-variant rounded-lg p-6 flex flex-col md:flex-row items-center justify-between bg-surface-container-lowest">
          <div className="flex items-center gap-4 mb-4 md:mb-0">
            <span className="material-symbols-outlined text-antique-gold text-3xl animate-pulse">
              verified_user
            </span>
            <div>
