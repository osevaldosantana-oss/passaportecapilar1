  ...
  return (
    <div className="min-h-screen flex flex-col font-body-lg">
      ...
      <header className="w-full px-margin-desktop py-8 flex justify-between items-center z-50 fixed top-0 glass-panel border-b-0 border-t-0 animate-stagger-1">
        ...
        <Link to="/dashboard" className="flex items-center gap-2 px-6 py-3 rounded-full border border-antique-gold/50 text-antique-gold hover:bg-antique-gold/10 transition-colors duration-500 font-label-caps text-label-caps uppercase">
