...
const pageCss = "\n        .qr-scanner-line {\n            position: absolute;\n            width: 100%;\n            height: 2px;\n            background: linear-gradient(90deg, transparent, rgba(197, 160, 89, 0.8), transparent);\n            box-shadow: 0 0 8px rgba(197, 160, 89, 0.5);\n            animation: scan 3s infinite linear;\n            top: 0;\n            left: 0;\n            z-index: 10;\n        }\n\n        @keyframes scan {\n            0% { top: 0; opacity: 0; }\n            10% { opacity: 1; }\n            90% { opacity: 1; }\n            100% { top: 100%; opacity: 0; }\n        }\n\n        .luxury-border {\n            position: relative;\n            background: linear-gradient(135deg, #4A0E0E, #2a0002);\n            padding: 4px;\n            border-radius: 12px;\n            box-shadow: 0 10px 30px rgba(74, 14, 14, 0.2);\n            animation: borderPulse 4s infinite ease-in-out;\n        }\n\n        @keyframes borderPulse {\n            0%, 100% {\n                box-shadow: 0 10px 30px rgba(74, 14, 14, 0.2), 0 0 0 rgba(197, 160, 89, 0);\n            }\n            50% {\n                box-shadow: 0 10px 30px rgba(74, 14, 14, 0.2), 0 0 20px rgba(197, 160, 89, 0.35);\n            }\n        }\n        \n        .luxury-border::before {\n            content: '';\n            position: absolute;\n            inset: 0;\n            border: 1px solid rgba(197, 160, 89, 0.3);\n            border-radius: 12px;\n            pointer-events: none;\n        }\n\n        .qr-inner {\n            background: #F9F6F0;\n            border-radius: 8px;\n            padding: 16px;\n            position: relative;\n            overflow: hidden;\n        }\n\n        .qr-shimmer {\n            position: absolute;\n            inset: 0;\n            background: linear-gradient(\n                110deg,\n                transparent 0%,\n                transparent 40%,\n                rgba(255, 255, 255, 0.8) 50%,\n                transparent 60%,\n                transparent 100%\n            );\n            background-size: 200% 100%;\n            animation: shimmerSweep 5s infinite linear;\n            pointer-events: none;\n            z-index: 5;\n            mix-blend-mode: overlay;\n        }\n\n        @keyframes shimmerSweep {\n            0% { background-position: 200% 0; }\n            20% { background-position: -100% 0; }\n            100% { background-position: -100% 0; }\n        }\n\n        .animate-text-pulse {\n            display: inline-block;\n            animation: textPulse 3s infinite ease-in-out;\n            transform-origin: center;\n        }\n\n        @keyframes textPulse {\n            0%, 100% { transform: scale(1); opacity: 1; }\n            50% { transform: scale(1.04); opacity: 0.75; }\n        }\n    \n\n    body {\n      min-height: max(884px, 100dvh);\n    }\n  ";

export const Route = createFileRoute("/_authenticated/identidade/perfil")({
  head: () => ({
    meta: [
      { title: "Perfil de Identidade — Passaporte Capilar™" },
      { name: "description", content: "Detalhes da identidade capilar e credenciais da edição diplomática." },
      { property: "og:title", content: "Perfil de Identidade — Passaporte Capilar™" },
      { property: "og:description", content: "Detalhes da identidade capilar e credenciais da edição diplomática." },
        ...
        <div className="w-full max-w-[280px] mb-8 animate-fade-in-up" style={{ animationDelay: "100ms" }}>
          <div className="luxury-border">
            <div className="qr-inner flex flex-col items-center justify-center">
              <div className="w-full aspect-square relative mb-4 flex items-center justify-center border border-outline-variant/30 bg-white overflow-hidden">
                <div className="qr-shimmer"></div>
                <div className="qr-scanner-line"></div>
                <img alt="QR Code Passaporte" className="w-[85%] h-[85%] object-contain relative z-0" data-alt="A high-contrast, intricately designed QR code, crisp and clear. The QR code features subtle integrated design elements suggesting luxury and security, perhaps a faint watermark of a seal in the background. It is presented on a clean, bright white background, evenly lit, ultra-sharp focus, professional graphic design aesthetic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDLVV22xtw6u1egWO4OqPQPfvHwmVulkQdVFAYjweq4wNwVKRAoIhi3aGPc2wc4dBG1r6zpV0nT5JdSNpGyl3D5IN7dSGOP_cntm-_5m-PLn5WOPQ4hczlu2gPdaBRONQI6zCFaWG47cBLbwz3g6i9_5BP7SkqJHqGFmHUx0E7Zgx4xTAciXm8bGZkFgbXGQMUynV2NE-oVmXHSuB_SigJAJgIVHaY4xy3qTykmXKDkDlGnsUoOoSi7" />
                <div className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2 border-antique-gold z-10"></div>
                <div className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 border-antique-gold z-10"></div>
                <div className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 border-antique-gold z-10"></div>
                <div className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2 border-antique-gold z-10"></div>
              </div>
              <div className="text-center w-full mt-2">
                <p className="font-metadata text-metadata text-outline tracking-widest uppercase mb-1">
                  ID: PC-2026
                </p>
                <p className="font-label-caps text-label-caps text-deep-burgundy animate-text-pulse cursor-pointer">
                  Validar Sessão
                </p>
              </div>
            </div>
